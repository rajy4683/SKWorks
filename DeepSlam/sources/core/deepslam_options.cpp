...
DeepSlamOptions::KeyframeMode DeepSlamOptions::KeyframeModeTranslator(const std::string& s)
{
  if (s == "AUTO")
...
std::string DeepSlamOptions::KeyframeModeTranslator(KeyframeMode mode)
{
  std::string name;
  switch (mode)
  {
...
DeepSlamOptions::TrackingMode DeepSlamOptions::TrackingModeTranslator(const std::string& s)
{
  if (s == "FIRST")
...
std::string DeepSlamOptions::TrackingModeTranslator(TrackingMode mode)
{
  std::string name;
  switch (mode)
  {
...
DeepSlamOptions::ConnMode DeepSlamOptions::ConnectionModeTranslator(const std::string& s)
{
  if (s == "FIRST")
...
std::string DeepSlamOptions::ConnectionModeTranslator(DeepSlamOptions::ConnMode mode)
{
  std::string name;
  switch (mode)
  {
