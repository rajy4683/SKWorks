...
public:
  ...
  //SE3F TrackAndGetNewPose(MapPtr map, bool current_tracking_state);
...
private:
  ...
  //                        Features& features);
  //SE3F TrackFrame(MapPtr map );
  //SE3F Relocalize(MapPtr map);

  //bool NewKeyframeRequired();
  //bool NewFrameRequired();
  //KeyframeId SelectKeyframe();
  //bool CheckTrackingLost(const SE3F& pose_wc);
