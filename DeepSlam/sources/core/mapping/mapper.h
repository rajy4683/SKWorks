...
#include "factor_pipeline_controller.h" //"work_manager.h"
#include "specialized_factor_tasks.h" //"df_work.h"
...
public:
  ...
  bool HasWork() const { return !pipeline_controller_.Empty(); }
...
private:
  ...
  work::FactorPipelineController pipeline_controller_; 
