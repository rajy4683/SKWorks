...
public:
  ...
  void Init(const df::PinholeCamera<float>& cam, df::DeepSlamOptions df_opts = df::DeepSlamOptions{});
  bool ShouldQuit();
  ...
  df::DeepSlamOptions GetSlamOpts() const { return df_opts_; }
