...
void LiveDemo<CS>::Init()
{
  ...
  slam_system_ = std::make_unique<df::DeepSlam<float,CS>>();
...
/* ************************************************************************* */
template <int CS>
void LiveDemo<CS>::StatsCallback(const DeepSlamStatistics& stats)
{
