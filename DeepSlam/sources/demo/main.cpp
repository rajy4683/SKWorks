...
int main(int argc, char* argv[])
{
  ...
  /* SLAM options */
  opts.df_opts.keyframe_mode = df::DeepSlamOptions::KeyframeModeTranslator(FLAGS_keyframe_mode);
  opts.df_opts.connection_mode = df::DeepSlamOptions::ConnectionModeTranslator(FLAGS_connection_mode);
  opts.df_opts.tracking_mode = df::DeepSlamOptions::TrackingModeTranslator(FLAGS_tracking_mode);
