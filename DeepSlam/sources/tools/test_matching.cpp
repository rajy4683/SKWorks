...
DEFINE_double(ransacMaxIterations, 10000, "Maximum iterations for RANSAC");
...
DEFINE_double(featuresMaxDist, 50, "Max feature dist threshold for outlier rejection");
...
int main(int argc, char** argv)
{
  ...
  LOG(INFO)<< "Files:"<< FLAGS_img0 << " " <<FLAGS_img1;
  ...
  cameraMatrix << 240.0f, 0.0f, 128.0f, 0.0f, 240.0f, 96.0f, 0.0f, 0.0f, 1.0f;
